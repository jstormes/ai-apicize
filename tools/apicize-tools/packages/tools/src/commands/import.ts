...
Converts TypeScript test files (generated by export) back into .apicize JSON format.
Extracts metadata from comments to reconstruct the original structure.
...
📝 Examples:
  ...
  apicize-tools import ./tests/myworkbook --no-validate`)
    .option('-o, --output <file>', 'output .apicize filename (default: {directory}.apicize)')
    .option('--overwrite', 'overwrite existing .apicize file without prompting')
    .option('--no-validate', 'skip validation of imported data (faster but risky)')
